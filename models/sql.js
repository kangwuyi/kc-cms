(function() {
	...
	mysqlString = {
		...
		k_feel_tags_k_feels: {
			...
			getTags: "select b.kt_feel_tags_ids,t.kt_feel_tags_name , count(0) as blogs_tags_num from k_feel_tags t,k_feels b where t.kt_feel_tags_ids=b.kt_feel_tags_ids  group by b.kt_feel_tags_ids order by blogs_tags_num desc;",
			getFeelsById: function(blogs_ids){
				return "select k.kt_feels_titles,k.kt_feels_contents,k.kt_feels_ids,k.kt_feel_tags_ids,t.kt_feel_tags_name,k.kt_feels_year,k.kt_feels_yue,k.kt_feels_ri  from k_feels k, k_feel_tags t where k.kt_feel_tags_ids = t.kt_feel_tags_ids and  k.kt_feels_ids="+blogs_ids;
			},
			getAll: function(changePer_page,per_page){
		...
		k_notes: {
			...
			getNotesById_count_all_result: function(notesTagsId){
				return "select count(0) as count_all_result from k_notes where kt_note_tags_ids="+notesTagsId+" order by count_all_result desc;";
			},
		...
		k_feels: {
			...
			getNotesById_count_all_result: function(feelsTagsId){
			...
			getFeelsByPrev: function(feelsId,tags_ids){
